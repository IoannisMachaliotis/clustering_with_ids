...
bool AEClustering::update(const std::deque<double> e){#include "grvc_e_clustering/AEClustering.h"
...
bool AEClustering::update(const std::deque<double> e)
{
    ...
    for (int ii = 0; ii < clusters.size(); ii++)
    {
        ...
        {
            // Remove the cluster when it is empty or when it needs refresh
